...
#include <cassert>
/*
    * Implementación de árbol binario con vector
    * Posee las funciones profundidad y altura
*/
...
private:
    ...
    int maxNodos; // tamaño del ve ctor
...
void Abin<T>::eliminarHijoIzqdoB(Abin<T>::nodo n)
{
    ...
    if (hizqdo != numNodos-1)
    {
        ...
        if (nodos[nodos[hizqdo].padre].hizq == numNodos-1)
            ...
            nodos[nodos[hizqdo].padre].hder = hizqdo;// Si el nodo movido tiene hijos,
